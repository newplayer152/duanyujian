#ifndef SINGLEWORDWIDGET_H
#define SINGLEWORDWIDGET_H
...
class SingleWordWidget : public QWidget {
    Q_OBJECT
signals:
    //候选字、小键盘、笔迹相关信号
...
public:
    ...
    SingleWordWidget(QWidget* parent = nullptr);
...
private:
    ...
    QString m_highlightedText;     // 当前鼠标悬停方块对应的文字
};

#endif //SINGLEWORDWIDGET_H
